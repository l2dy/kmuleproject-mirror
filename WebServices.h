...
class CWebServices
{
  public:
    ...
    int GetFileMenuEntries(CTitleMenu* pMenu)
    {
        return GetAllMenuEntries(pMenu, WEBSVC_FILE_URLS);
    }
    int GetGeneralMenuEntries(CTitleMenu* pMenu)
    {
        return GetAllMenuEntries(pMenu, WEBSVC_GEN_URLS);
    }
