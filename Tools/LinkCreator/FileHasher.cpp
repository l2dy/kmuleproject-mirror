...
void CAddFileThread::SetValues(LPCTSTR directory, LPCTSTR filename)
{
...
int CAddFileThread::Run()
{
	...
	if (newrecord->CreateFromFile(m_strDirectory, m_strFilename) && theApp.m_pLinkCreatorDlg != NULL ) // SLUGFILLER: SafeHash - in case of shutdown while still hashing
	{
