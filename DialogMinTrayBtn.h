...
public:
    ...
    void MinTrayBtnShow();
    void MinTrayBtnHide();
    __inline BOOL MinTrayBtnIsVisible() const
    {
    ...
    __inline BOOL MinTrayBtnIsEnabled() const
    {
...
private:
    ...
    __inline const CPoint &MinTrayBtnGetPos() const
    {
        return m_MinTrayBtnPos;
    }
    __inline const CSize &MinTrayBtnGetSize() const
    {
        return m_MinTrayBtnSize;
    }
    __inline CRect MinTrayBtnGetRect() const
    {
