...
public:
    ...
    void	SetClientID(uint32 nClientID)
    {
    ...
    uint32	GetClientServerIP() const
    {
        return m_nClientServerIP;
    }
    void	SetClientServerIP(uint32 uIP)
    {
    ...
    void	SetKadPublishInfo(uint32 dwVal)
    {
        m_nKadPublishInfo = dwVal;
    }
    uint32	GetKadPublishInfo() const
    {
    ...
    void	SetSpamRating(uint32 nRating)
    {
        m_nSpamRating = nRating;
    }
    uint32	GetSpamRating() const
    {
