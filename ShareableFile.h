...
public:
    ...
    const CString& GetSharedDirectory() const
    {
        return m_strSharedDirectory.IsEmpty() ? m_strDirectory : m_strSharedDirectory;
    }
    void SetSharedDirectory(LPCTSTR path)
    {
        m_strSharedDirectory = path;
    }
    bool IsShellLinked() const
    {
        return !m_strSharedDirectory.IsEmpty();
    }
