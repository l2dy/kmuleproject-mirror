...
// START: Codecs from Windows SDK "mmreg.h" file
    ...
    { 0x0017, _T("DIALOGIC_OKI_ADPCM"),		L"" },
    { 0x0018, _T("MEDIAVISION_ADPCM"),		L"" },
    { 0x0019, _T("CU_CODEC"),				_T("Hewlett-Packard Company") },
    { 0x0020, _T("YAMAHA_ADPCM"),			L"" },
    { 0x0021, _T("SONARC"),					_T("Speech Compression") },
    { 0x0022, _T("DSPGROUP_TRUESPEECH"),	L"" },
    ...
    { 0x0030, _T("DOLBY_AC2"),				L"" },
    { 0x0031, _T("GSM610"),					L"" },
    { 0x0032, _T("MSNAUDIO"),				L"" },
    { 0x0033, _T("ANTEX_ADPCME"),			L"" },
    { 0x0034, _T("CONTROL_RES_VQLPC"),		L"" },
    { 0x0035, _T("DIGIREAL"),				_T("DSP Solutions, Inc.") },
    { 0x0036, _T("DIGIADPCM"),				_T("DSP Solutions, Inc.") },
    { 0x0037, _T("CONTROL_RES_CR10"),		L"" },
    ...
    { 0x003B, _T("ROCKWELL_ADPCM"),			L"" },
    { 0x003C, _T("ROCKWELL_DIGITALK"),		L"" },
    { 0x003D, _T("XEBEC"),					L"" },
    ...
    { 0x0059, _T("LUCENT_G723"),			L"" },
    { 0x0060, _T("CIRRUS"),					L"" },
    { 0x0061, _T("ESPCM"),					_T("ESS Technology") },
    { 0x0062, _T("VOXWARE"),				L"" },
    { 0x0063, _T("CANOPUS_ATRAC"),			L"" },
    { 0x0064, _T("G726_ADPCM"),				_T("APICOM") },
    { 0x0065, _T("G722_ADPCM"),				_T("APICOM") },
    { 0x0067, _T("DSAT_DISPLAY"),			L"" },
    { 0x0069, _T("VOXWARE_BYTE_ALIGNED"),	L"" },
    { 0x0070, _T("VOXWARE_AC8"),			L"" },
    { 0x0071, _T("VOXWARE_AC10"),			L"" },
    { 0x0072, _T("VOXWARE_AC16"),			L"" },
    { 0x0073, _T("VOXWARE_AC20"),			L"" },
    { 0x0074, _T("VOXWARE_RT24"),			L"" },
    { 0x0075, _T("VOXWARE_RT29"),			L"" },
    { 0x0076, _T("VOXWARE_RT29HW"),			L"" },
    { 0x0077, _T("VOXWARE_VR12"),			L"" },
    { 0x0078, _T("VOXWARE_VR18"),			L"" },
    { 0x0079, _T("VOXWARE_TQ40"),			L"" },
    { 0x0080, _T("SOFTSOUND"),				L"" },
    { 0x0081, _T("VOXWARE_TQ60"),			L"" },
    { 0x0082, _T("MSRT24"),					L"" },
    ...
    { 0x0093, _T("MEDIASONIC_G723"),		L"" },
    { 0x0094, _T("PROSODY_8KBPS"),			_T("Aculab plc") },
    { 0x0097, _T("ZYXEL_ADPCM"),			L"" },
    { 0x0098, _T("PHILIPS_LPCBB"),			L"" },
    { 0x0099, _T("PACKED"),					_T("Studer Professional Audio AG") },
    { 0x00A0, _T("MALDEN_PHONYTALK"),		L"" },
    { 0x0100, _T("RHETOREX_ADPCM"),			L"" },
    { 0x0101, _T("IRAT"),					_T("BeCubed Software Inc.") },
    { 0x0111, _T("VIVO_G723"),				L"" },
    { 0x0112, _T("VIVO_SIREN"),				L"" },
    { 0x0123, _T("DIGITAL_G723"),			_T("Digital Equipment Corporation") },
    { 0x0125, _T("SANYO_LD_ADPCM"),			L"" },
    { 0x0130, _T("SIPROLAB_ACEPLNET"),		L"" },
    { 0x0130, _T("SIPR"),					_T("Real Audio 4 (Sipro)") },
    { 0x0131, _T("SIPROLAB_ACELP4800"),		L"" },
    { 0x0132, _T("SIPROLAB_ACELP8V3"),		L"" },
    { 0x0133, _T("SIPROLAB_G729"),			L"" },
    { 0x0134, _T("SIPROLAB_G729A"),			L"" },
    { 0x0135, _T("SIPROLAB_KELVIN"),		L"" },
    { 0x0140, _T("G726ADPCM"),				_T("Dictaphone Corporation") },
    { 0x0150, _T("QUALCOMM_PUREVOICE"),		L"" },
    { 0x0151, _T("QUALCOMM_HALFRATE"),		L"" },
    ...
    { 0x0170, _T("UNISYS_NAP_ADPCM"),		L"" },
    { 0x0171, _T("UNISYS_NAP_ULAW"),		L"" },
    { 0x0172, _T("UNISYS_NAP_ALAW"),		L"" },
    { 0x0173, _T("UNISYS_NAP_16K"),			L"" },
    { 0x0200, _T("CREATIVE_ADPCM"),			L"" },
    { 0x0202, _T("CREATIVE_FASTSPEECH8"),	L"" },
    { 0x0203, _T("CREATIVE_FASTSPEECH10"),	L"" },
    { 0x0210, _T("UHER_ADPCM"),				L"" },
    { 0x0220, _T("QUARTERDECK"),			L"" },
    ...
    { 0x1600, _T("MPEG_ADTS_AAC"),			L"" },
    { 0x1601, _T("MPEG_RAW_AAC"),			L"" },
    { 0x1608, _T("NOKIA_MPEG_ADTS_AAC"),	L"" },
    { 0x1609, _T("NOKIA_MPEG_RAW_AAC"),		L"" },
    { 0x160A, _T("VODAFONE_MPEG_ADTS_AAC"),	L"" },
    { 0x160B, _T("VODAFONE_MPEG_RAW_AAC"),	L"" },
    ...
    for (int i = 0; i < _countof(s_WavFmtTag); i++)
    {
        if (_tcsicmp(s_WavFmtTag[i].pszDefine, strCodecId) == 0)
        {
            if (s_WavFmtTag[i].uFmtTag == 0)
                break;
            if (s_WavFmtTag[i].pszDefine[0] == L'\0' || s_WavFmtTag[i].pszComment[0] == L'\0')
                break;
