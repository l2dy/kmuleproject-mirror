...
class CDepSettings
{
  public:
    ...
    LPCTSTR GetVirtDirName()
    {
        return m_strVirtDirName;
    }
    LPCTSTR GetVirtDirFSPath()
    {
        return m_strVirtDirFSPath;
    }
    LPCTSTR GetExtensionFileName()
    {
        return m_strExtFileName;
    }
    bool GetRegIsapi()
    {
        return m_bRegIsapi;
    }
    bool GetUnloadBeforeCopy()
    {
        return m_bUnloadBeforeCopy;
    }
    bool SkipVirtDirCreation()
    {
        return m_bDoNotCreateVirtDir;
    }
    int GetAppIsolation()
    {
