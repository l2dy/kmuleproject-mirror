...
public:
    ...
    const CAICHHash& GetAICHHash() const
    {
        ...
        return m_AICHFileHash;
    }
    void			SetAICHHash(const CAICHHash& Hash);
    bool			HasAICHHash() const
    {
        return m_bHasValidAICHHash;
    }
    void			ClearAICHHash()
    {
...
public:
    ...
    uint16			GetAvailableMD4PartHashCount() const
    {
        return (uint16)m_aMD4HashSet.GetCount();    /* prev: GetHashCount() */
    }
    bool			HasExpectedMD4HashCount() const
    {
        return GetTheoreticalMD4PartHashCount() == GetAvailableMD4PartHashCount();
    }

    CArray<uchar*, uchar*>&	GetRawMD4HashSet()
    {
        return m_aMD4HashSet;
    }
    ...
    uint16			GetAvailableAICHPartHashCount() const
    {
        return (uint16)m_aAICHPartHashSet.GetCount();
    }
    bool			HasExpectedAICHHashCount() const
    {
        return GetTheoreticalAICHPartHashCount() == GetAvailableAICHPartHashCount();
    }

    const CArray<CAICHHash>&	GetRawAICHHashSet()	const
    {
