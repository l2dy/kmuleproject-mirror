...
#define	TBBTN_SEARCH	(IDC_TOOLBARBUTTON + 1)
#define	TBBTN_SHARED	(IDC_TOOLBARBUTTON + 2)
#define	TBBTN_MESSAGES	(IDC_TOOLBARBUTTON + 3)
#define	TBBTN_STATS		(IDC_TOOLBARBUTTON + 4)
#define	TBBTN_OPTIONS	(IDC_TOOLBARBUTTON + 5)
#define	TBBTN_TOOLS		(IDC_TOOLBARBUTTON + 6)
#define	TBBTN_HELP		(IDC_TOOLBARBUTTON + 7)
