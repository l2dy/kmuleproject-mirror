...
class CRoutingZone
{
  ...
  public:
    ...
    UINT		ReadFile(CString strSpecialNodesdate = L"");
    ...
    CContact*	GetRandomContact(UINT nMaxType, UINT nMinKadVersion) const;
    ...
    void		GetClosestTo(UINT uMaxType, const CUInt128 &uTarget, const CUInt128 &uDistance, UINT uMaxRequired, ContactMap *plistResult, bool bEmptyFirst = true, bool bSetInUse = false) const;
