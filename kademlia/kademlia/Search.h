...
public:
    ...
    {
        return pNodeSpecialSearchRequester;
    }
    void				SetNodeSpecialSearchRequester(CKadClientSearcher* pNew)
    {
        pNodeSpecialSearchRequester = pNew;
    }

    CLookupHistory* GetLookupHistory() const
    {
        return m_pLookupHistory;
    }
    enum
    {
        NODE,
