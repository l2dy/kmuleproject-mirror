...
class CStatisticFile
{
  public:
    ...
    UINT	GetRequests() const
    {
        return requested;
    }
    UINT	GetAccepts() const
    {
        return accepted;
    }
    ...
    UINT	GetAllTimeRequests() const
    {
        return alltimerequested;
    }
    UINT	GetAllTimeAccepts() const
    {
        return alltimeaccepted;
    }
    uint64	GetAllTimeTransferred() const
    {
