...
#define EMULE_GUID_BASE			L"{4EADC6FC-516F-4b7c-9066-97D893649570}"
#ifdef _DEBUG
#define EMULE_GUID				(L"EMULE-" EMULE_GUID_BASE L"-DEBUG")
#else
#define EMULE_GUID				(L"EMULE-" EMULE_GUID_BASE)
#endif
