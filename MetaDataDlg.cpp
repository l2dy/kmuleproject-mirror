...
void CMetaDataDlg::Localize()
{
    ...
    HDITEM hdi;
    hdi.mask = HDI_TEXT;
    for (int i = 0; i < m_tags.GetHeaderCtrl()->GetItemCount(); ++i)
    {
        CString strRes;
        strRes = GetResString(s_aColumns[i].uHeadResID);
    ...
    //force a refresh to update the tags' labels
    //seems to be unneeded because eMule looses focus on the selected files and tabs when localizing (another bug?)
    //RefreshData();
}
...
CString GetTagNameByID(UINT id)
{
    ...
    {
    case FT_FILENAME:
        return GetResString(IDS_SW_NAME);
    case FT_FILESIZE:
        return GetResString(IDS_DL_SIZE);
    case FT_FILETYPE:
        return GetResString(IDS_TYPE);
    case FT_FILEFORMAT:
        return GetResString(IDS_FORMAT);
    case FT_LASTSEENCOMPLETE:
        return GetResString(IDS_LASTSEENCOMPL);	// 01-Nov-2004: Sent in server<->client protocol as 'Last Seen Complete'
    case 0x06:
        return GetResString(IDS_META_PARTPATH);
    case 0x07:
        return GetResString(IDS_META_PARTHASH);
    case FT_TRANSFERRED:
        return GetResString(IDS_DL_TRANSF);
    case FT_GAPSTART:
        return GetResString(IDS_META_GAPSTART);
    case FT_GAPEND:
        return GetResString(IDS_META_GAPEND);
    case 0x0B:
        return GetResString(IDS_DESCRIPTION);
    case 0x0C:
        return GetResString(IDS_PING);
    case 0x0D:
        return GetResString(IDS_FAIL);
    case 0x0E:
        return GetResString(IDS_META_PREFERENCES);
    case 0x0F:
        return GetResString(IDS_PORT);
    case 0x10:
        return GetResString(IDS_IP);
    case 0x11:
        return GetResString(IDS_META_VERSION);
    case FT_PARTFILENAME:
        return GetResString(IDS_META_TEMPFILE);
    case 0x13:
        return GetResString(IDS_PRIORITY);
    case FT_STATUS:
        return GetResString(IDS_STATUS);
    case FT_SOURCES:
        return GetResString(IDS_SEARCHAVAIL);
    case 0x16:
        return GetResString(IDS_PERMISSION);
    case 0x17:
        return GetResString(IDS_FD_PARTS);
    case FT_COMPLETE_SOURCES:
        return GetResString(IDS_COMPLSOURCES);
    case FT_MEDIA_ARTIST:
        return GetResString(IDS_ARTIST);
    case FT_MEDIA_ALBUM:
        return GetResString(IDS_ALBUM);
    case FT_MEDIA_TITLE:
        return GetResString(IDS_TITLE);
    case FT_MEDIA_LENGTH:
        return GetResString(IDS_LENGTH);
    case FT_MEDIA_BITRATE:
        return GetResString(IDS_BITRATE);
    case FT_MEDIA_CODEC:
        return GetResString(IDS_CODEC);
    case FT_FILECOMMENT:
        return GetResString(IDS_COMMENT);
    case FT_FILERATING:
        return GetResString(IDS_QL_RATING);
    case FT_FILEHASH:
        return GetResString(IDS_FILEHASH);
    case 0xFA:
        return GetResString(IDS_META_SERVERPORT);
    case 0xFB:
        return GetResString(IDS_META_SERVERIP);
    case 0xFC:
        return GetResString(IDS_META_SRCUDPPORT);
    case 0xFD:
        return GetResString(IDS_META_SRCTCPPORT);
    case 0xFE:
        return GetResString(IDS_META_SRCIP);
    case 0xFF:
        return GetResString(IDS_META_SRCTYPE);
//>>> WiZaRd::CollectionEnhancement
    case FT_AICH_HASH:
        return GetResString(IDS_AICHHASH);
//<<< WiZaRd::CollectionEnhancement
    }
