...
public:
    ...
    const CString& GetFileType() const
    {
    ...
    CFileIdentifier& GetFileIdentifier()
    {
        return m_FileIdentifier;
    }
    const CFileIdentifier& GetFileIdentifierC() const
    {
        return m_FileIdentifier;
    }
    const uchar* GetFileHash() const
    {
        return m_FileIdentifier.GetMD4Hash();
    }
    ...
    const CArray<CTag*, CTag*>& GetTags() const
    {
        return taglist;
    }
    ...
    void	SetHasComment(bool in)
    {
        m_bHasComment = in;
    }
    UINT	UserRating(bool bKadSearchIndicator = false) const
    {
        return (bKadSearchIndicator && m_bKadCommentSearchRunning)  ? 6 : m_uUserRating;
    }
    bool	HasRating()	const
    {
        return m_uUserRating > 0;
    }
    ...
    const	CKadEntryPtrList& getNotes() const
    {
        return m_kadNotes;
    }

    bool			IsKadCommentSearchRunning() const
    {
        return m_bKadCommentSearchRunning;
    }
