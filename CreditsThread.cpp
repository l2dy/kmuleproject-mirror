...
//>>> WiZaRd::ModCredits
    sTmp.Format(L"03:00:%s Team", MOD_VERSION_PLAIN);
    m_arCredits.Add(sTmp);
...
// 	m_arCredits.Add(L"S:5");
// 	m_arCredits.Add(L"01:06:???");
// 	m_arCredits.Add(L"S:10");

// 	m_arCredits.Add(L"02:04:Translated by");
// 	m_arCredits.Add(L"S:5");
// 	m_arCredits.Add(L"01:06:Some language: ???");
// 	m_arCredits.Add(L"S:5");
// 	m_arCredits.Add(L"S:10");

// 	m_arCredits.Add(L"02:04:Tested by");
// 	m_arCredits.Add(L"S:5");
// 	m_arCredits.Add(L"01:06:some tester");
// 	m_arCredits.Add(L"S:10");

    sTmp.Format(L"03:00:%s is based on eMule", MOD_VERSION_PLAIN);
    m_arCredits.Add(sTmp);
    m_arCredits.Add(L"S:5");
    m_arCredits.Add(L"01:06:Official credits are following...");
    m_arCredits.Add(L"S:25");
//<<< WiZaRd::ModCredits
