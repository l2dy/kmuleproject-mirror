...
public:
    ...
    {
        return new CDirectoryItem(m_strFullPath, 0, m_eItemType, m_nCatFilter);
    }
...
public:
    ...
    bool			IsCreatingTree() const
    {
        return m_bCreatingTree;
    };
    void			Localize();
...
protected:
    ...
    CTitleMenu			m_SharePermissionsMenu; //>>> WiZaRd::SharePermissions
